...
public class CalendarProgram extends JFrame{
    ...
    public  CalendarProgram (){
        ...
        pnlCalendar.setBorder(BorderFactory.createTitledBorder("Kalendarz"));
        ...
        String[] headers = {"Pon", "Wto", "Œro", "Czw", "Pi¹", "Sob", "Nie"}; 
        for (int i=0; i<7; i++){
    ...
    public static void refreshCalendar(int month, int year){
        String[] months =  {"Styczeñ", "Luty", "Marzec", "Kwiecieñ", "Maj", "Czerwiec", "Lipiec", "Sierpieñ", "Wrzesieñ", "Pazdziernik", "Listopad", "Grudzieñ"};
        int nod, som; 
